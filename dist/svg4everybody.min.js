...
if(b){var c=d(a),e=!c.hasAttribute("viewBox")&&b.getAttribute("viewBox");
// conditionally set the viewBox on the svg
e&&c.setAttribute("viewBox",e);
// clone the target
var f=b.cloneNode(!0);if("symbol"===b.nodeName.toLowerCase()){
// copy the contents of the clone into the fragment
for(
// create a document fragment to hold the contents of the target
var g=document.createDocumentFragment();f.childNodes.length;)g.appendChild(f.firstChild);
// append the fragment into the svg
a.appendChild(g)}else
// remove the id to keep the document valid
f.removeAttribute("id"),a.appendChild(f)}}function b(b){
